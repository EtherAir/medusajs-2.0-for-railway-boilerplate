...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_posts_tag" AS ENUM('Our mission', 'Science', 'Ingredients', 'Rituals', 'Learn');
  CREATE TYPE "public"."enum_posts_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_version_tag" AS ENUM('Our mission', 'Science', 'Ingredients', 'Rituals', 'Learn');
  ...
  CREATE TABLE "_posts_v" (
  	...
  	"version_tag" "enum__posts_v_version_tag",
  ...
  CREATE TABLE "site_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"announcement" varchar DEFAULT 'Free shipping on US orders over $250.',
  	"free_shipping_threshold" numeric DEFAULT 250,
  	"community_line" varchar DEFAULT 'FOLLOW. ENGAGE. FLOURISH.
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_posts_tag";
  DROP TYPE "public"."enum_posts_status";
  DROP TYPE "public"."enum__posts_v_version_tag";
